...
describe('CaixaDaLanchonete', () => {
    ...
    ])('compra simples em %p deve resultar em %p', (_, metodoDePagamento, resultadoEsperado, itens) =>
        validaTeste(metodoDePagamento, resultadoEsperado, itens));

    test.each([
        ['credito', 'R$ 11,85', ['cafe,1', 'sanduiche,1', 'queijo,1']],
        ['debito', 'R$ 11,50', ['cafe,1', 'sanduiche,1', 'queijo,1']],
    ])('compra de 3 itens em %p deve resultar em %p', (_, metodoDePagamento, resultadoEsperado, itens) =>
    validaTeste(metodoDePagamento,resultadoEsperado,itens));
    ...
    ])('compra de múltiplas quantidades em %p deve resultar em %p', (_, metodoDePagamento, resultadoEsperado, itens) =>
    validaTeste(metodoDePagamento,resultadoEsperado,itens));
